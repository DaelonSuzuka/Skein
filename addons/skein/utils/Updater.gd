...
var file_list_url = 'https://github.com/DaelonSuzuka/Skein/raw/file_list/file_list.json'
var base_url = 'https://github.com/DaelonSuzuka/Skein/raw/master/'
...
func unzip_and_apply_update():
	var existing_files = Skein.files.get_all_files('res://addons/skein')
	var checked_files = []
